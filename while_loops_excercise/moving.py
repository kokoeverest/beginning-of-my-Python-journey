...
while total_volume >= all_packets:
    packets = input()
    if packets == "Done" or all_packets == total_volume:
        print(f"{total_volume - all_packets} Cubic meters left.")
        break
    all_packets += int(packets)
else:
    print(f'No more free space! You need {all_packets - total_volume} Cubic meters more.')
'''
