...
for i in range(1, age + 1):
    if i % 2 == 0:
        money_from_birthdays += money_given - 1
        money_given += 10
    else:
        toys += 1

money_from_birthdays += toys * toy_price

if money_from_birthdays >= washing_machine_price:
    print(f'Yes! {money_from_birthdays - washing_machine_price:.2f}')
else:
    print(f'No! {washing_machine_price - money_from_birthdays:.2f}')
